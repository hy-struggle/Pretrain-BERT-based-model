...
import numpy as np
import random
from NEZHA import BertTokenizer, BertForMaskedLM, NEZHAConfig
from NEZHA import WarmupLinearSchedule, BertAdam
from NEZHA import torch_init_model
...
parser.add_argument('--save_name', type=str, default="nezha_financial_tapt",
                    help="The prefix used for saving the remote model")
parser.add_argument('--gradient_accumulation_steps', type=int, default=2,
                    help="Number of updates steps to accumulate before performing a backward/update pass.")
parser.add_argument("--train_batch_size", default=38, type=int,
...
if __name__ == '__main__':
    ...
    config = NEZHAConfig.from_json_file(os.path.join(params.bert_model_dir, 'bert_config.json'))
